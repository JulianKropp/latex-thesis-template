...
\newcommand{\myProf}{Prof. Dr. Max Mustermann}
\newcommand{\myOtherProf}{Prof. Dr. Maxine Mustermann}
\newcommand{\myTime}{30. September 2025}
...
\input{layout/header_footer_formatting.tex} % Header and footer configuration
...
\input{layout/list_of_tables_figures.tex}
\input{bibliography/abbreviation.tex}
